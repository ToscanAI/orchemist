...
class ProgressTracker:
    ...
    def _update_task_summary(self, event: ProgressEvent) -> None:
        ...
        """,
            [
                ...
                event.cost_usd or "0.00",
                event.memory_mb or 0,
                0,
                0,  # retry_count and escalation_count are calculated in the UPDATE
    ...
    def stream_task_events(
        self, task_id: str, since: Optional[datetime] = None
    ...
    def task_started(
        self, task_id: str, worker_id: str, session_id: str = None, message: str = None
    ) -> None:
    ...
    def task_completed(
        self, task_id: str, worker_id: str = None, tokens_used=None, cost_usd: str = None
    ) -> None:
    ...
    def model_escalated(
        self, task_id: str, from_tier: str, to_tier: str, attempt_number: int, worker_id: str = None
    ) -> None:
